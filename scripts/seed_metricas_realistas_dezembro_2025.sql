-- ====================================================================
-- SCRIPT DE MÉTRICAS REALISTAS - DEZEMBRO 2025
-- Faturamento total: R$ 100.000 EXATO (soma de todas campanhas)
...
DECLARE
    ...
    faturamento_total_desejado NUMERIC := 100000; -- R$ 100.000 no total
    ...
    dias_trabalho INTEGER := 30; -- Dezembro sem Natal (25/12)
    
BEGIN
    -- ====================================================================
    -- LIMPEZA: Apagar APENAS métricas de dezembro 2025
    -- ====================================================================
    DELETE FROM metricas 
    WHERE periodo_inicio >= '2025-12-01' 
      AND periodo_fim <= '2025-12-31';
    
    RAISE NOTICE '🗑️  Métricas de dezembro 2025 removidas';
    RAISE NOTICE '==================================================';
    ...
    RAISE NOTICE '💰 Faturamento total a distribuir: R$ 100.000,00';
    ...
    LOOP
        ...
        LOOP
            ...
            -- Pular Natal (NÃO incrementar contador)
            IF dia_mes = '2025-12-25' THEN
                CONTINUE;
            END IF;
            
            dia_count := dia_count + 1;  -- Incrementar DEPOIS de pular Natal
...
FROM metricas
WHERE periodo_inicio >= '2025-12-01' AND tipo = 'campanha'
UNION ALL
SELECT 
