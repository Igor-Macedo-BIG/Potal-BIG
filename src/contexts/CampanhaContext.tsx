      ...
      if (!metricasArray || metricasArray.length === 0) {
        ...
        if (exata) {
          const metricas: MetricasAgregadas = {
            ...
            visitas_perfil: toNumber(exata.visitas_perfil),
            video_views: toNumber(exata.video_views),
            roas: 0,
            ctr: 0,
            cpm: 0,
            cpc: 0,
          ...
          const metricas: MetricasAgregadas = (metricasArray as any[]).reduce((acc, m) => ({
            ...
            visitas_perfil: acc.visitas_perfil + toNumber(m.visitas_perfil),
            video_views: acc.video_views + toNumber(m.video_views),
            roas: 0,
            ctr: 0,
            cpm: 0,
            cpc: 0,
    ...
    try {
      ...
      if (empId && campanhaIdsEmpresa.length === 0) {
        ...
        setMetricasGerais({
          ...
          visitas_perfil: 0, video_views: 0,
